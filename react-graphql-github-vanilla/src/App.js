...
const GET_ISSUES_OF_REPOSITORY = `
  query GetIssuesOfRepository ($organization: String!, $repository: String!, $cursor: String) {
...
const removeStarFromRepository = () => {
  // todo
}
    ...
    return (
      <div className="App">
        <header className="App-header">
          <h1 className="App-title">REACT-GRAPHQL-GITHUB-CLIENT </h1>
        </header>

        <form onSubmit={this.onSubmit}>
          <label htmlFor="url">
            Show open issues for https://github.com/
            <input id="url" type="text" onChange={this.onChange} value={path} style={{ width: '300px' }} />
          </label>
